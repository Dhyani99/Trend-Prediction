	...
	<div class="content">
		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				...
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon ti-bar-chart"></i><span>Manage User</span><span class="menu-arrow fa fa-angle-down"></span></a>
				...
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon ti-bar-chart"></i><span>Manage Dataset</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
