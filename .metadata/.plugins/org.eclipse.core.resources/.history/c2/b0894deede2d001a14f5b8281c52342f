...
<div id="notification-popup" class="notice-popup js__toggle" data-space="75">
	...
	<div class="content">
		<ul class="notice-list">
			...
			<li>
				<a href="#">
					<span class="avatar"><img src="adminResource/image
...
<div id="wrapper">
				...
				<div class="box-content">
					...
					<h1 class="page-title">Add Keyword</h1>
						<div class="form-group">
							...
							<p>Domain</p><select class="form-control select2_1 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
						...
						</select><span class="select2 select2-container select2-container--default select2-container--above" dir="ltr" style="width: 474.5px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-48cr-container"><span class="select2-selection__rendered" id="select2-48cr-container" ></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
					
						</div>
						<div class="form-group">
							<label for="inputName" class="control-label">Keyword</label>
							<input type="text" class="form-control" id="inputName" placeholder="Enter Keyword" required>
						</div>
	...
	<!-- Validator -->
	<script src="adminResource/js/validator.min.js"></script>
