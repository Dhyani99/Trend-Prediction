				...
				<div class="box-content">
					<form data-toggle="validator">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="inputName" placeholder="Enter Domain" required>
						</div>
						...
						<div class="form-group">
								...
								<textarea class="form-control" id="inp-type-5" placeholder="Enter domain description"></textarea>
