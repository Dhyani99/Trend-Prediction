		...
		<div class="row small-spacing">
			<div class="col-12">
				<div class="box-content">
					...
					<h1 class="page-title">VIEW COMPLAIN</h1>
						<div class="form-group">
							<label for="inputName" class="control-label">Complain Subject: </label>
							<input type="text" class="form-control" id="inputName" placeholder="Enter complain subject" required>
						</div>
						...
						<div class="form-group">
								...
								<textarea class="form-control" id="inp-type-5" placeholder="Enter complain description"></textarea><br>
