			...
			<ul class="menu js__accordion">
				...
				<!-- <li>
					...
					<ul class="sub-menu js__content">
						<li><a href="chart-3d.html">View User</a></li>
				...
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon ti-menu-alt"></i><span>Manage Domain</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
						<li><a href="loadDomain">Add Domain</a></li>
						<li><a href="viewDomain">View Domain</a></li>
						<li><a href="chart-chartjs.html">Chartjs Chart</a></li>
						<li><a href="chart-dynamic.html">Dynamic Chart</a></li>
						<li><a href="chart-flot.html">Flot Chart</a></li>
						<li><a href="chart-knob.html">Knob Chart</a></li>
				...
				<!-- <li>
					<a class="waves-effect" href="#"><i class="menu-icon ti-stats-up"></i><span>Manage Prediction</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
				...
				<li>
					<a class="waves-effect" href="widgets.html"><i class="menu-icon ti-bell"></i><span>Manage Notification</span></a>
				</li>
				<!-- <li>
					...
					<ul class="sub-menu js__content">
						...
						<li><a href="datatable.jsp">Data Tables</a></li>
